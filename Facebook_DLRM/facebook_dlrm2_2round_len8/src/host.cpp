...
//////////////////////////////   TEMPLATE END  //////////////////////////////
    ...
    for (int j = 0; j < 2 * BATCH_SIZE; j++) {
        access_idx_2_round[j] = idx_random_2_round[j];
    }
...
//////////////////////////////   TEMPLATE START  //////////////////////////////
        ...
        source_sw_results[result_addr] += 
            HBM_embedding0[access_idx_2_round[2 * result_addr] * PADDED_SIZE_HBM_0];
        source_sw_results[result_addr] += 
            HBM_embedding1[access_idx_2_round[2 * result_addr] * PADDED_SIZE_HBM_1];
        source_sw_results[result_addr] += 
            HBM_embedding2[access_idx_2_round[2 * result_addr] * PADDED_SIZE_HBM_2];
        source_sw_results[result_addr] += 
            HBM_embedding3[access_idx_2_round[2 * result_addr] * PADDED_SIZE_HBM_3];
        source_sw_results[result_addr] += 
            HBM_embedding4[access_idx_2_round[2 * result_addr] * PADDED_SIZE_HBM_4];
        source_sw_results[result_addr] += 
            HBM_embedding5[access_idx_2_round[2 * result_addr] * PADDED_SIZE_HBM_5];
        source_sw_results[result_addr] += 
            HBM_embedding6[access_idx_2_round[2 * result_addr] * PADDED_SIZE_HBM_6];
        source_sw_results[result_addr] += 
            HBM_embedding7[access_idx_2_round[2 * result_addr] * PADDED_SIZE_HBM_7];
        source_sw_results[result_addr] += 
            HBM_embedding8[access_idx_2_round[2 * result_addr] * PADDED_SIZE_HBM_8];
        source_sw_results[result_addr] += 
            HBM_embedding9[access_idx_2_round[2 * result_addr] * PADDED_SIZE_HBM_9];
        source_sw_results[result_addr] += 
            HBM_embedding10[access_idx_2_round[2 * result_addr] * PADDED_SIZE_HBM_10];
        source_sw_results[result_addr] += 
            HBM_embedding11[access_idx_2_round[2 * result_addr] * PADDED_SIZE_HBM_11];
        source_sw_results[result_addr] += 
            HBM_embedding12[access_idx_2_round[2 * result_addr] * PADDED_SIZE_HBM_12];
        source_sw_results[result_addr] += 
            HBM_embedding13[access_idx_2_round[2 * result_addr] * PADDED_SIZE_HBM_13];
        source_sw_results[result_addr] += 
            HBM_embedding14[access_idx_2_round[2 * result_addr] * PADDED_SIZE_HBM_14];
        source_sw_results[result_addr] += 
            HBM_embedding15[access_idx_2_round[2 * result_addr] * PADDED_SIZE_HBM_15];
